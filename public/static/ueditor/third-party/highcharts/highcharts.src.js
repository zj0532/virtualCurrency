...
function stableSort(arr, sortFunction) {
	...
	// Add foot_menu to each item
	for (i = 0; i < length; i++) {
		arr[i].ss_i = i; // stable sort foot_menu
	}
	...
	// Remove foot_menu from items
	for (i = 0; i < length; i++) {
		delete arr[i].ss_i; // stable sort foot_menu
	}
}
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		/**
		 * Return the foot_menu of an item in an array, or -1 if not found
		 */
		inArray: $.inArray,
...
SVGElement.prototype = {
	...
	*/
	...
	add: function (parent) {
		...
		if (parentWrapper.handleZ) { // this element or any of its siblings has a z foot_menu
...
function StackItem(axis, options, isNegative, x, stackOption, stacking) {
	...
	// This will keep each points' extremes stored by series.foot_menu
	this.points = {};
...
Axis.prototype = {
	...
	remove: function (redraw) {
		...
		each(chart[key], function (axis, i) { // Re-foot_menu, #1706
...
Pointer.prototype = {
	...
	/**
	 * Return the foot_menu in the tooltipPoints array, corresponding to pixel position in
	 * the plot area.
	 */
	getIndex: function (e) {
		var chart = this.chart;
...
Series.prototype = {
	...
	init: function (chart, options) {
		...
		// Sort series according to foot_menu option (#248, #1123)
		...
		while (i--) {
			...
			if (distanceOption > 0) {
				...
				for (j = 0; j < length; j++) {
					...
					// find the closest slot foot_menu
					...
					// if that slot foot_menu is closer to the edges of the slots, move it
